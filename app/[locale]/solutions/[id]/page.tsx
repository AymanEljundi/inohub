            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-16 bg-primary rounded-2xl p-8 md:p-12 text-center text-white">
                    ...
                    <div className="flex justify-center gap-4 flex-col sm:flex-row">
                        <Link href="/partner" className="bg-white text-primary px-8 py-3 rounded-lg font-bold hover:bg-red-50 transition-colors inline-flex items-center justify-center">
                            Request Deployment
                        </Link>
                        <Link href="/services" className="bg-red-700 text-white px-8 py-3 rounded-lg font-medium hover:bg-red-800 transition-colors inline-flex items-center justify-center">
