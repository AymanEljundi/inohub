        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
          ...
          <FadeIn direction="up" delay={0.2}>
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-[2.5rem] p-10 md:p-16 overflow-hidden relative shadow-2xl border-2 border-gray-700">
              ...
              <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-red-900/10 rounded-full blur-[100px] pointer-events-none" />

              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  <div>
                    <div className="rounded-full px-3 py-1 text-sm font-semibold leading-6 text-red-400 ring-1 ring-inset ring-red-400/20 bg-red-500/10 w-fit mb-6">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">
                      Premium Hardware, <br />
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-600">Verified Quality</span>
                    </h2>
                    <p className="text-gray-400 text-xl leading-relaxed">
                      Source the exact components we use in our enterprise deployments. Professional grade servers, sensors, and networking gear.
                    </p>
                  </div>
                ...
                <div className="hidden lg:flex relative h-80 w-full group">
                  <div className="absolute inset-0 bg-white/5 backdrop-blur-md rounded-3xl border-2 border-dashed border-gray-600 flex items-center justify-center transition-all duration-500 group-hover:border-red-500/50 group-hover:bg-white/[0.07]">
                    <div className="text-center p-8 space-y-4">
                      <div className="w-16 h-px bg-red-500/50 mx-auto" />
                      <p className="text-gray-500 font-mono text-xs uppercase tracking-widest">Global Logistics Network</p>
                      <p className="text-4xl font-extrabold text-white tracking-tight group-hover:text-red-400 transition-colors">techstorelb.com</p>
                      <p className="text-gray-400 text-sm font-medium">Infrastructure Components & Systems</p>
                      <div className="pt-4 flex justify-center">
                        <div className="px-6 py-2 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 text-sm font-bold group-hover:bg-red-500 group-hover:text-white transition-all cursor-pointer">
                          Browse Store ↗
                        </div>
                      </div>
                    </div>
