    ...
    return (
        <div id="register" className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gray-900 px-8 py-6">
                ...
                <p className="text-gray-300 text-sm mt-1">Submit your location for evaluation.</p>
            </div>
            ...
            <form action={clientAction} className="p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input name="orgName" id="orgName" type="text" required className="w-full px-4 py-3 bg-gray-50 border border-gray-200 text-gray-900 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none placeholder:text-gray-500" placeholder="e.g. Jounieh Municipality" />
                    </div>
                    <div>
                        <label htmlFor="email" className="block text-sm font-bold text-gray-900 mb-2">Contact Email</label>
                        <input name="email" id="email" type="email" required className="w-full px-4 py-3 bg-gray-50 border border-gray-200 text-gray-900 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none placeholder:text-gray-500" placeholder="mayor@jounieh.gov.lb" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="locationDetails" id="locationDetails" required rows={3} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 text-gray-900 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none resize-none placeholder:text-gray-500" placeholder="Address, Plot Number, or Coordinates..."></textarea>
                </div>
