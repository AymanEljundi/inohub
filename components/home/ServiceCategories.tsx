...
const categories = [
    ...
    },
    {
        ...
        description: "Charging stations and network management for businesses and homes.",
        icon: Shield,
        color: "text-red-600",
    ...
    },
    {
        ...
        description: "Catalog of high-quality hardware for all your infrastructure needs.",
        icon: Server,
        color: "text-gray-500",
