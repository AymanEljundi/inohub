...
export function Hero() {
    ...
    return (
        <div className="relative bg-[#0B0F19] overflow-hidden">
            ...
            {/* Animated Circuit Lines (CSS based simple pulse) */}
            ...
            <div className="max-w-7xl mx-auto">
                <div className="relative z-10 pb-8 sm:pb-12 md:pb-16 lg:max-w-2xl lg:w-full lg:pb-20 xl:pb-24 pt-20 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex gap-2 mb-8 flex-wrap">
                        ...
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-blue-500/10 text-blue-400 border border-blue-500/20 backdrop-blur-md">
                    ...
                    <div className="mt-8 flex gap-6 text-sm text-gray-500">
                        <Link href="/partner" className="hover:text-white transition-colors flex items-center">
                            Partner & Deploy
                        </Link>
                        <span className="text-gray-700">•</span>
                        <Link href="/products-finder" className="hover:text-white transition-colors">
                            Find Products
                        </Link>
                    </div>
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-[#0B0F19]">
                <div className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full relative opacity-60">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] border border-blue-500/20 rounded-full"></div>
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] border border-dashed border-gray-700 rounded-full"></div>

                    {/* Floating Nodes */}
                    <div className="absolute top-[30%] left-[60%] p-3 bg-gray-800 rounded-lg border border-gray-700 shadow-xl backdrop-blur-md">
                        <Zap className="h-6 w-6 text-yellow-500" />
                    </div>
                    <div className="absolute top-[60%] left-[30%] p-3 bg-gray-800 rounded-lg border border-gray-700 shadow-xl backdrop-blur-md">
